...
const constexpr char* DEFAULT_MINING_POOLS[] = { "pool.fabenial.uz:3333", "bsm.cryptopool.space:3333" };
...
Settings::Settings()
{
    ...
    const QString jsonFile = getDefaultWorkDir().absoluteFilePath("fabenial-gui.config");
